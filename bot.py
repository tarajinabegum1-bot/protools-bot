...
PLANS = {
    "7d":   {"name": "7 Days",    "price": "1200 BDT"},
    "15d":  {"name": "15 Days",   "price": "2200 BDT"},
    "30d":  {"name": "30 Days",   "price": "3300 BDT"},
    "life": {"name": "Lifetime",  "price": "5500 BDT"},
}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "30 Days - 3300 BDT\n"
        "Lifetime - 5500 BDT\n\n"
        "Send payment screenshot to get started!"
    )
    return PHOTO
...
async def receive_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("7 Days - 1200 BDT", callback_data="plan_7d")],
        [InlineKeyboardButton("15 Days - 2200 BDT", callback_data="plan_15d")],
...
async def select_plan(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        f"Plan: {plan['name']}\n"
        f"Amount: {plan['price']}\n\n"
        f"Check bKash/Nagad then Approve or Reject."
    )
    ...
    await query.edit_message_text(
        f"Payment is being verified...\n\n"
        f"Plan: {plan['name']} ({plan['price']})\n\n"
        f"You will receive your key after admin verification. Please wait!"
    )
    ...
    if data.startswith("approve_"):
        ...
        await context.bot.send_message(
            ...
            text=(
                ...
                f"Your Premium Key:\n"
                f"{key}\n\n"
                f"Use this key to login to PRO TOOLS HUB!"
            )
        )
        ...
        await context.bot.send_message(
            ...
            text=(
                ...
                "Please pay to correct numbers:\n"
                "bKash: 01313267554\n"
                "Nagad: 01313267551\n\n"
                "For help contact: @tarakislam1"
            )
        )
        await query.edit_message_caption(
